...
if (isset($_POST['submit'])) {
    $description = $_POST['description'];
        mysqli_query($connection, "UPDATE privacypolicy
        SET description = '$description'
        WHERE id = '1'");
    header('location: privacypolicy.php');
    $aboutus_fetch = $connection->query("SELECT * from privacypolicy");
}
else{
    $aboutus_fetch = $connection->query("SELECT * from privacypolicy");
}
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">RISK KARMA Privacy Policy</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                    ...
                    <div id="panel-1" class="panel panel-default">
                        ...
                        <div class="panel-body">
                                <form action="" enctype="multipart/form-data" method="POST">
                                    ...
                                    echo '<label for="inputEmail4">RISK KARMA Privacy Policy Description</label>
