...
if (isset($_POST['submit'])) {
    $description = $_POST['description'];
        mysqli_query($connection, "UPDATE ecosystempartners
        SET description = '$description'
        WHERE id = '1'");
    header('location: ecosystempartners.php');
    $aboutus_fetch = $connection->query("SELECT * from ecosystempartners");
}
else{
    $aboutus_fetch = $connection->query("SELECT * from ecosystempartners");
}
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Eco System Partners</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                    ...
                    <div id="panel-1" class="panel panel-default">
                        ...
                        <div class="panel-body">
                                <form action="" enctype="multipart/form-data" method="POST">
                                    ...
                                    echo '<label for="inputEmail4">Eco System Partners</label>
