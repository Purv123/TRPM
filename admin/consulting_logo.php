...
if (isset($_POST['submit'])) {
    ...
    $img = trim($_POST['img']);
        ...
        // WHERE id = $service_id");
    // echo "INSERT INTO  consulting_logo(`title`,`content`,`image`)
    //  VALUES ('$title','$content', '$img')";
    mysqli_query($connection, "INSERT INTO  consulting_logo(`image`)
     VALUES ('$img')");
    header('location: consulting_logo.php');
    $blog_fetch = $connection->query("SELECT * from consulting_logo");
}else if (isset($_GET['delete'])) {
    $blog_id = $_REQUEST['delete'];
    $delprod = $connection->query("DELETE FROM consulting_logo WHERE id='$blog_id'");
    header('location: consulting_logo.php');
    $blog_fetch = $connection->query("SELECT * from consulting_logo");
}else {
    $blog_fetch = $connection->query("SELECT * from consulting_logo");
    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">Consulting Logos</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                ...
                <div id="content" class="dashboard padding-20">
                    ...
                    <div id="panel-1" class="panel panel-default">
                        <div class="panel-heading">
                            <div id="page-title">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">ADD Consulting Logos</button>
                                <div class="modal fade" id="myModal" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title">ADD Consulting Logos</h6>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <input type="submit" name="submitLogo" value="ADD" class="btn btn-primary">
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                            ...
                            <div id="flot-sales" class="fullwidth ">
                               ...
                               <table class="table table-bordered table-hover">
                                ...
                                while ($row = mysqli_fetch_array($blog_fetch)) {
                                    echo '<tr>
                                            <td><a href="consulting_logo.php?delete=' . $row['id'] . '">DELETE</a></td>
