                ...
                <div class="footer-content pt-3">
                            ...
                            <div class="footer-widget">
                                ...
                                <ul>
                                    ...
                                    if(basename($_SERVER['PHP_SELF']) == "termsofuse.php")
                                        echo "class=active";
                                    ?> >Terms Of Use</a></li>
                                    <li><a href="../.././technicalgrade/technical-grade/technicalriskinsight.php" class="active">Technical Risk Insights</a></li>
                    ...
                    <div class="row center">
                        <b class="p-3" style="color: white; font-size: 1rem;"><?php
                            echo '<span style="color: #e31e24; font-weight:900; font-size:1.5rem;">[ </span> <q>  69% of companies have suffered from a security breach resulting from vendor access in the last year. </q> <span style="color: #e31e24; font-weight:900; font-size:1.5rem;">] </span>';
                        ?>
                        </b>
                    </div>
                </div>
