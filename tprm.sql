...
(1, 'tprm', 'contact', 'email', '', '', '', '', '', 'subject'),
(2, 'tprm', 'contact', 'subject', '', '', '', '', '', 'message');
...
('root', '[{\"db\":\"tprm\",\"table\":\"contactdescription\"},{\"db\":\"tprm\",\"table\":\"aboutus\"},{\"db\":\"tprm\",\"table\":\"tprmasservice\"},{\"db\":\"tprm\",\"table\":\"usecases\"},{\"db\":\"tprm\",\"table\":\"whyriskkarma\"},{\"db\":\"tprm\",\"table\":\"services\"},{\"db\":\"tprm\",\"table\":\"commitment\"},{\"db\":\"tprm\",\"table\":\"blog\"},{\"db\":\"tprm\",\"table\":\"contact\"},{\"db\":\"tprm\",\"table\":\"servicedescription\"}]');
...
('root', '2021-07-19 12:39:58', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":234}');
...
-- Database: `tprm`
--
CREATE DATABASE IF NOT EXISTS `tprm` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tprm`;
...
(1, '', 'Essentials', 'Advance', 'Professional', 'Enterprise', 'Up to 15 Supplier Assessment Reports/Month'),
(2, '', '$295/Report', '$495/Report', '$795/Report', '$995/Report', '$10,000/Monthly'),
(3, 'Supplier Cyber Risk Posture Report/w Data Breach Index and Ransomware Index & Continuous Monitoring', 'true', 'true', 'true', 'true', 'true'),
...
(8, 'SOC Assessments Services', 'false', 'false', 'false', 'true', 'true'),
